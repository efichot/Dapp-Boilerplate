...
module.exports = {
  ...
  entry: {
    popup: ['babel-polyfill', "react-hot-loader/patch", path.join(__dirname, "../", "src", "extension", "js","popup", "index.js")],
    options: path.join(__dirname, "../", "src", "extension", "js", "options.js"),
    background: path.join(__dirname,  "../", "src", "extension", "js", "background.js"),
    monitor: path.join(__dirname, "../", "src", "extension", "js","monitor.js"),
  },
  output: {
  ...
  resolve: {
    ...
    alias: {
     extensionStore: path.resolve(__dirname, '../src/extension/js/popup/interface/store'),
      extensionTheme: path.resolve(__dirname, '../src/extension/js/popup/interface/theme'),
      extensionContainers: path.resolve(__dirname, '../src/extension/js/popup/interface/containers'),
      layout: path.resolve(__dirname, '../src/extension/js/popup/interface/layout'),
      workshop: path.resolve(__dirname, '../src/extension/js/popup/interface/workshop'),

      /*--- Level 1 ---*/
      settings: path.resolve(__dirname, '../src/extension/js/popup/settings'),
      static: path.resolve(__dirname, '../src/extension/js/popup/static'),
