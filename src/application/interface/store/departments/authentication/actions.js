...
/*--- Email/Password Login ---*/
export const AUTH_REGISTER_WITH_EMAIL_PASSWORD_REQUEST = 'AUTH_REGISTER_WITH_EMAIL_PASSWORD_REQUEST'
export const AUTH_REGISTER_WITH_EMAIL_PASSWORD_SUCCESS = 'AUTH_REGISTER_WITH_EMAIL_PASSWORD_SUCCESS'
export const AUTH_REGISTER_WITH_EMAIL_PASSWORD_FAILURE = 'AUTH_REGISTER_WITH_EMAIL_PASSWORD_FAILURE'
...
export const authRegisterWithEmailPassword = ({payload = {}, metadata = {}}) => ({
  type: AUTH_REGISTER_WITH_EMAIL_PASSWORD_REQUEST,
  payload,
  metadata
})
