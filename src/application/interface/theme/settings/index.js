const theme = {
  ...
  gradient: {
    ...
    green: ['#7B920A', '#ADD100'],
    gray: ['#e7dfdf', '#f3f8fa'],
    greenBlue: ['#159957', '#155799'],
    crimson: ['#642B73', '#C6426E'],
    crimsonMix: ['#83315b','#582ba0'],
    greenLush: ['#56ab2f', '#a8e063'],
    greenDeep: ['#414d0b', '#727a17'],
    greenLeaf: ['#76b852', '#8DC26F'],
    greenLime: ['#FDFC47', '#24FE41'],
    green1: ['#ABDCFF', '#0396FF'],
    green2: ['#90F7EC', '#32CCBC'],
    green3: ['#81FBB8', '#28C76F'],
    green4: ['#FFF720', '#3CD500'],
    green5: ['#70F570', '#49C628'],
    lime: '#F4D03F 0%, #16A085 100%',
    limeSubtle: ['#3CA55C', '#B5AC49'],
    limeHarmonic: ['#16A085', '#F4D03F'],
    ...
    blackTransparent: 'rgba(0,0,0, 0.70), rgba(56, 56, 56, 0.45) 40%, transparent 80%, transparent 100%',
    purpleTransparent: 'rgba(31, 15, 83, 0.89), rgba(65, 36, 135, 0.45) 40%,transparent 80%,transparent 100%',
  },
  textShadows: {
    0: [
