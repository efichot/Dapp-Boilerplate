...
export default (props) => {
  ...
  const nameOrgLegal = idx(props.data, _ => _.name.nameOrganizationLegal)
...
return <Flex direction={['row']} align='stretch' justify='center' w={[1]} {...props} >
  ...
  <Box {...mainLayout}>
    <Heading f={[4]} level={3} display='inline-block' children={nameOrg|| null} />
    <Heading f={[2]} level={3} color='blue' ml={[5]} display='inline-block' children={nameOrgLegal} />
